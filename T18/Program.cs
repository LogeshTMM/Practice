...
internal class Program {
   ...
   static int ArmStrong (string num) {
      int result = 0;
      foreach (int a in num) result += (int)(Math.Pow (a - 48, num.Length));
      /* ASCII CODE FOR 1 is 49, assume that a subtract by 48 (a - 48;) to get int value 1. According to 'char 1'.*/
