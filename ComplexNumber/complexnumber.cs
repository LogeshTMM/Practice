...
public class ComplexNumber {
   ...
   public static string Addition (double aReal, double aImg, double bReal, double bImg)
      => $"{aReal + bReal} + {aImg + bImg}i";

   // The user provides four parameter values for the subtraction operation between two complex numbers.
   public static string Subraction (double aReal, double aImg, double bReal, double bImg)
      => $"{aReal - bReal} - ({aImg - bImg}i)";

   // It performs a magnitude operation on a single complex number.
   public static double Magnitude (double aReal, double aImg)
