...
internal class Program {
   static void Main (string[] args) {
      ...
      string n = Console.ReadLine (); char[] j = { }; char m;
      ...
      if (user_respond_key == 'w' || user_respond_key == 'b') {
         if (n_len >= 1 || n_len <= 5) {
            Console.Write ($"\nThe Word format for a given number {n} is ");
            if (n_len == 5) {
            ...
            if (n_len == 2) {
               ...
               else if (t1 == 1 && t2 >= 1) Console.Write ($"{tens[t1].ToUpper ()}");
      ...
      if (user_respond_key == 'r' || user_respond_key == 'b') {
         if (n_len == 1 || n_len <= 5) {
            Console.Write ($"\nThe Roman numerals format for a given number {n} is ");
            if (n_len == 5) {
               for (int i = 1; i <= n_len; i++) {
                  m = n[i - 1];
                  j = j.Append (m).ToArray ();
            ...
            if (n_len == 2) {
               ...
               else if (t1 == 1 && t2 >= 1) Console.Write ($"{roman_tens[t1]}");
               else if (t1 > 1 && t2 >= 1) Console.Write ($"{roman_tens_2[t1]}");
               //
